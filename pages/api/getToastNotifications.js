...
const data = [
  {
    ...
    scheduledTime: new Date('January 19, 2022 10:42:00').getTime(), // Time for the message to be sent to the App
  ...
  {
    id: 2,
    scheduledTime: new Date('January 19, 2022 10:42:40').getTime(),
    displayWindow: 60000 * 5,
    message: "Welco9me to the bigggg show BRODNOA"
  },
  {
    id: 3,
    scheduledTime: new Date('January 19, 2022 10:44:00').getTime(),
    displayWindow: 60000 * 5,
